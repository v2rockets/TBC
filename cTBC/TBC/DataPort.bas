...
Set mFile = mFileS.GetFile("C:\exchange.txt")
...
wshS.Run "G:\cTBC\Release\cTBC.exe", vbHide, True
Set mFile = mFileS.GetFile("C:\strange.txt")
...
Public Function ConnecttoC1() As MoveMsg

'wshS.Run "G:\cTBC\Release\cTBC-t.exe", vbHide, True
wshS.Run "G:\cTBC-new\Release\cTBC.exe", vbHide, True
Set mFile = mFileS.GetFile("C:\strange.txt")
Set mtxt = mFile.OpenAsTextStream(ForReading)
ConnecttoC1.info = mtxt.ReadLine
ConnecttoC1.s = Asc(mtxt.ReadLine) - Asc("A")
ConnecttoC1.l1 = Asc(mtxt.ReadLine) - Asc("A")
ConnecttoC1.ltag = Asc(mtxt.ReadLine) - Asc("A")
ConnecttoC1.k = Asc(mtxt.ReadLine) - Asc("A")
mtxt.Close
End Function
